      ...
      <div className="relative">
        <section className="relative px-4 pb-12 pt-24 text-center sm:px-6 lg:px-8">
          ...
          <div className="mx-auto max-w-5xl">
            <p className="mb-4 text-sm font-medium tracking-wide text-primary drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">Free Live Webinar</p>
            <h1 className="mx-auto max-w-4xl text-balance text-4xl font-semibold tracking-tight text-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.5)] sm:text-5xl">
                How to Build a Personal Brand Content System That Runs 90% Without You
              </h1>
