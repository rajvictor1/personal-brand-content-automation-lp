...
export const metadata: Metadata = {
  title: "Free LinkedIn Carousel Generator | AI Slides",
  description:
    ...
    <>
      ...
      <section className="relative px-4 pb-12 pt-16 text-center sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-5xl">
          <Reveal>
            <p className="mb-4 text-sm font-medium tracking-wide text-primary drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">Free Solo plan available</p>
          </Reveal>
          <Reveal delay={0.1}>
            <h1 className="mx-auto max-w-3xl text-balance text-4xl font-semibold tracking-tight text-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.5)] sm:text-5xl lg:text-6xl">
              AI LinkedIn Carousel Generator from one research topic
            </h1>
          </Reveal>
          <Reveal delay={0.2}>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <Reveal>
            <h2 className="mb-8 text-center text-2xl font-semibold tracking-tight text-foreground">Everything you need to build LinkedIn carousels</h2>
          </Reveal>
