    ...
    <>
      ...
      <section className="relative px-4 pb-12 pt-16 text-center sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-5xl">
          <p className="mb-4 text-sm font-medium tracking-wide text-primary drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">Review-First Publishing</p>
      ...
      <section className="px-4 py-16 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-5xl">
          <Reveal delay={0.2}>
            <h2 className="mb-8 text-center text-2xl font-semibold tracking-tight text-foreground">Why review-first matters</h2>
          </Reveal>
        ...
        <div className="mx-auto max-w-5xl">
          <Reveal delay={0.3}>
            <div className="rounded-2xl border border-white/10 bg-card p-8">
              <h3 className="text-2xl font-semibold tracking-tight text-foreground">Never publish by accident</h3>
