    ...
    <>
      ...
      <section className="relative px-4 pb-12 pt-16 text-center sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-5xl">
          <p className="mb-4 text-sm font-medium tracking-wide text-primary drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">Review-first LinkedIn automation for consultants</p>
