    ...
    <>
      ...
      <section className="relative px-4 pb-12 pt-16 text-center sm:px-6 lg:px-8">
        ...
        <div className="mx-auto max-w-5xl">
          <p className="mb-4 text-sm font-medium tracking-wide text-primary drop-shadow-[0_2px_10px_rgba(0,0,0,0.5)]">Review-first LinkedIn automation</p>
          <h1 className="mx-auto max-w-3xl text-balance text-4xl font-semibold tracking-tight text-white drop-shadow-[0_2px_20px_rgba(0,0,0,0.5)] sm:text-5xl lg:text-6xl">
              LinkedIn Automation Tool for founders and trainers
            </h1>
        ...
        <div className="mx-auto max-w-5xl">
          <Reveal>
            <div className="rounded-2xl border border-white/10 bg-card/40 p-6 sm:p-8">
              <h2 className="mb-6 text-center text-2xl font-semibold tracking-tight text-foreground">Built for operators like you</h2>
        ...
        <div className="mx-auto max-w-5xl">
          <Reveal delay={0.3}>
            <div className="rounded-2xl border border-white/10 bg-card/40 p-8">
              <h3 className="text-2xl font-semibold tracking-tight text-foreground">Automate your LinkedIn content workflow</h3>
