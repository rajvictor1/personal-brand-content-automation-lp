...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticPages = [
    ...
    { url: `${base}/resources/webinars`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${base}/webinar`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.8 },
    ...
    { url: `${base}/services/linkedin-content`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${base}/services/ai-website-design-development`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${base}/services/website-lead-magnets`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${base}/services/aeo-geo-visibility`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    { url: `${base}/services/youtube-research`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${base}/geo-scorecard`, lastModified: new Date(), changeFrequency: "weekly", priority: 0.95 },
